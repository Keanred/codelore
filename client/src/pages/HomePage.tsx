...
export const HomePage = () => {
  ...
  return (
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      {isError && <Typography color="error">Failed to load items. Is the server running?</Typography>}

      {items && items.length === 0 && <Typography color="text.secondary">No items yet.</Typography>}
